...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query(value = "SELECT u.id AS id,u.username AS username,u.password AS password,u.role AS role FROM users u WHERE u.username = :username", nativeQuery = true)
    Optional<LoginUserProjection> findBaseUserOnly(@Param("username") String username);
